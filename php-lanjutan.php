...
$data = array('Supra', 'Vega', 'Beat', 'Scoopy', 'Fazio', 'Vario' );
...
/*
if ($nama == "Bila") {
    echo $nama."adalah gadis Jawa";
} else if($nama == "Manggala") {
...
<body>
    ...
    <?php
        if(!empty($_POST['submit'])) {
            ...
            switch($_POST['nama']) {
                case "Bila":
                    $pesan = $_POST['nama']." adalah gadis Jawa";
                break;
                case "Manggala":
